...
function () {
  function History() {
    ...
    this.onHashchange = function (e) {
      var urlList = JSON.parse(localStorage.getItem(HISTORYKEY) || '[]');
      var curPageArr = urlList.filter(function (item) {
        return item.state == historyState;
      });

      if (curPageArr && curPageArr.length > 0) {
        var fullUrl = curPageArr[0].fullUrl;
...
var getWrappedComponent = function getWrappedComponent(component) {
  ...
  function (_component) {
    ...
    function Wrapped(props, context) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Wrapped).call(this, props, context));
    ...
    _createClass(Wrapped, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (canReceiveProps && _get(_getPrototypeOf(Wrapped.prototype), "componentWillReceiveProps", this)) {
          _get(_getPrototypeOf(Wrapped.prototype), "componentWillReceiveProps", this).call(this, nextProps);
        }
      ...
      value: function componentDidMount() {
        _get(_getPrototypeOf(Wrapped.prototype), "componentDidMount", this) && _get(_getPrototypeOf(Wrapped.prototype), "componentDidMount", this).call(this);
        this.defaultShow = true;
        _get(_getPrototypeOf(Wrapped.prototype), "componentDidShow", this) && _get(_getPrototypeOf(Wrapped.prototype), "componentDidShow", this).call(this);
        this.renderTitle();
      }
    }, {
      key: "componentWillUnmount",
      value: function componentWillUnmount() {
        _get(_getPrototypeOf(Wrapped.prototype), "componentDidHide", this) && _get(_getPrototypeOf(Wrapped.prototype), "componentDidHide", this).call(this);
        _get(_getPrototypeOf(Wrapped.prototype), "componentWillUnmount", this) && _get(_getPrototypeOf(Wrapped.prototype), "componentWillUnmount", this).call(this);
      }
    }, {
      key: "renderTitle",
      value: function renderTitle() {
        var title = this.config && this.config.navigationBarTitleText;
      ...
      value: function render() {
        ...
        }, _get(_getPrototypeOf(Wrapped.prototype), "render", this).call(this));
      }
    }]);
...
function (_Component) {
  ...
  function Router() {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Router).apply(this, arguments));
